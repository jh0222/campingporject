...
public class Campingplace {
	...
	public Campingplace(int cam_no, String cam_bo_id, String cam_name, String cam_txt, String cam_phonenumber,
			int cam_price, String cam_address, String cam_latitude, String cam_longitude, int cam_headcount) {
		super();
		this.cam_no = cam_no;
