...
<body>
	<form action="member.milkitlogin" method="POST" name="loginForm">
		<div class="gocamping_login">
			<div class="login_id_box">
				...
				<input name="fpr_u_bo_id" type="hidden" value="${sessionScope.loginMember2.bo_id }${sessionScope.loginMember.u_id }">
			</div>
