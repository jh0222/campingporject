...
<jsp:include page="${myPage }"></jsp:include>
	<form action="user.update?u_id="${sessionScope.loginMember.u_id }"
		...
		<table id="joinTable">
			...
			<tr>
				<td colspan="2" align="center">	사용자 정보	</td>
			</tr>
			<tr>
				<td>ID</td>
				<td>
			...
			<tr>
				<td>PW</td>
				<td>
					<input name="u_pw" value="${sessionScope.loginMember.u_pw }" placeholder="필수, 숫자 하나이상 반드시"  maxlength="10" autocomplete="off">
				</td>
			</tr>
			<tr>
				<td>PW확인</td>
				<td><input name="u_pwChk" value="${sessionScope.loginMember.u_pw }" placeholder="필수, 숫자 하나이상 반드시" type="password" maxlength="10" autocomplete="off"></td>
			</tr>
			<tr>
				<td>이름</td>
				<td><input name="u_name" readonly="readonly" value="${sessionScope.loginMember.u_name }" placeholder="필수" maxlength="10" autocomplete="off"></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td>
					<input name="u_email" value="${email[0] }" type="text" readonly="readonly" required><span id="middle">@</span>
					<input name="u_email_address" value="${email[1] }" type="text" readonly="readonly" required>					
				</td>
			</tr>
			<tr>
				<td class="td1">주소</td>
				<td class="td2">
					<input id="addr3Input" value="${addr[2] }" name="u_addr3" maxlength="5" autocomplete="off" placeholder="우편번호">
					<span id="addrSearchBtn">[검색]</span><br>
					<input id="addr1Input" value="${addr[0] }" name="u_addr1" maxlength="30" autocomplete="off" placeholder="주소">
         ...
         -
         <input name="phonenumber2"class="phonenumber" maxlength='4' value="<c:out value="${fn:substring(sessionScope.loginMember.u_phonenumber, 3, 7)}"></c:out>">
         -
         <input name="phonenumber3"class="phonenumber" maxlength='4' value="<c:out value="${fn:substring(sessionScope.loginMember.u_phonenumber, 7, 11)}"></c:out>">
				</td>
			</tr>
			<tr>
				<td class="td1">프로필 사진</td>
				<td>
					<img src="resources/img/${sessionScope.loginMember.u_picture }" id="updateMemberPhoto" weight="200" height="100"><br>
				</td>
