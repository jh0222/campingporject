...
<p style="font-size: 30px;"><b>나의 캠핑 활동</b></p>
	<ul id="nav-v2">
		...
		<li class="menu-v2"><a href="userbuylist?b_u_bo_id=${sessionScope.loginMember.u_id}">구매 내역</a></li>
		<li class="menu-v2">
			<a href="productreview?pr_u_bo_id=${sessionScope.loginMember.u_id}&fpr_u_bo_id=${sessionScope.loginMember.u_id}">구매후기</a>
		</li>
	</ul>
<p style="font-size: 30px;"><b>커뮤니티</b></p>
	<ul id="nav-v2">
		<li class="menu-v2"><a href="freeboard?f_u_id=${sessionScope.loginMember.u_id}">자유게시판</a></li>
		<li class="menu-v2"><a href="campingtip?tip_u_id=${sessionScope.loginMember.u_id}">레시피</a></li>
		<li class="menu-v2"><a href="recipe?rb_u_id=${sessionScope.loginMember.u_id}">캠핑팁</a></li>
