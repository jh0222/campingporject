...
<div class="row">
  ...
  <div class="column middle">
  	<c:choose>
		<c:when test="${empty campingtipreview}">
			<h1>작성된 내용이 없습니다.</h1>
		</c:when>
	<c:otherwise>
	...
	<c:forEach var="ctp" items="${campingtipreview}">
		<tr>
			...
			<td class="td1">
				<button onclick="campingtipreviewup('${ctp.tipr_no}','${ctp.tipr_u_id}')">수정</button>
				<button onclick="campingtipreviewdel('${ctp.tipr_no}','${ctp.tipr_u_id}')">삭제</button>
			</td>
		</tr>
	</c:forEach>
	</table>
