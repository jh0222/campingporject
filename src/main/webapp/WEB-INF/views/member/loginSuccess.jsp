...
<c:when test="${sessionScope.loginMember.u_id != null}">
	<table>
		<tr>	
			...
			<td>
				<button onclick="location.href='cart?ba_u_bo_id=${sessionScope.loginMember.u_id}&fba_u_bo_id=${sessionScope.loginMember.u_id}'">장바구니</button>
...
<c:when test="${sessionScope.loginMember2.bo_id != null}">
	<table>
		<tr>			
			...
			<td>
				<button onclick="location.href='cart?ba_u_bo_id=${sessionScope.loginMember2.bo_id}&fba_u_bo_id=${sessionScope.loginMember2.bo_id}'">장바구니</button>
